...
class DuaContainer extends StatelessWidget {
  ...
  final String? ref;
  const DuaContainer({Key? key,this.text = "",this.translation = "",this.ref}) : super(key: key);
      ...
      child: Consumer<FontProvider>(
        builder: (context, fontProvider, child) {
          return Column(
            children: [
              Text(
                text == "" ? 'رَبَّنَا وَاجْعَلْنَا مُسْلِمَیْنِ لَكَ وَمِن ذُرِّیَّتِنَآ أُمَّةً مُّسْلِمَةً لَّكَ وَأَرِنَا مَنَاسِكَنَا وَتُبْ عَلَیْنَآ إِنَّكَ أَنتَ التَّوَّابُ الرَّحِیمُ':text!,
