...
class AppTranslationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: buildAppBar(
          context: context, title: localeText(context, "app_language")),
      body: Column(
        children: [
          Expanded(
                    ...
                    children: [
                      Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: AssetImage(
                                        'assets/images/flags/${lang.flag}.png')),
                                borderRadius: BorderRadius.circular(6.r)),
                          ),
                          // Container(
                          ...
                          //       borderRadius: BorderRadius.circular(6.r)
                          //   ),
                          //   child: Text(lang.flag,style: TextStyle(fontSize: 20.sp,),overflow: TextOverflow.clip,),
                          // ),
                          // color: AppColors.grey2
                          Text(localeText(context, lang.name),
                              style: TextStyle(
