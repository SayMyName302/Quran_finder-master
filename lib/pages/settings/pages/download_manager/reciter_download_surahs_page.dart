        ...
        children: [
          ...
          Consumer<DownloadManagerProvider>(
            builder: (context, value, child) {
              return Expanded(
                child: value.downloadSurahs.isNotEmpty
                    ? ListView.builder(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        value.recitersName!.reciterName!,
                                        style: TextStyle(
                                            fontSize: 15.5.sp,
                                            fontFamily: "satoshi",
                                      ...
                                      Text(
                                        '${surah.surahName}, Chapter ${surah.surahId}',
                                        style: TextStyle(
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                      ...
                                      child: CircleButton(
                                          ...
                                          icon: ImageIcon(
                                            const AssetImage(
                                                'assets/images/app_icons/trash.png'),
                                            size: 11.h,
                                          ))),
                                )
                              ],
                    ...
                    : const Center(
                        child: Text('No Audio For this reciter'),
                      ),
              );
            },
          ),
