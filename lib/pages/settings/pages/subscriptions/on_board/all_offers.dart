...
class AllOffers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var style12 = TextStyle(
        fontFamily: 'satoshi', fontWeight: FontWeight.w400, fontSize: 12.sp);
          ...
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.only(
                  top: 14.h, left: 20.w, right: 20.w, bottom: 14.h),
              decoration: BoxDecoration(
                  color: appColor, borderRadius: BorderRadius.circular(16.r)),
              child: Column(
                children: [
                  Text(
                    "Limited Time Offer for Unlimited Perks & Benefits",
                    style: TextStyle(
                        fontFamily: 'satoshi',
                  ...
                  Container(
                    padding:
                        EdgeInsets.symmetric(vertical: 7.h, horizontal: 19.w),
            ...
            Row(
              children: [
                Expanded(
                  child: Container(
                    padding: EdgeInsets.only(
                        top: 7.94.h, bottom: 12.h, left: 12.w, right: 12.w),
                    decoration: BoxDecoration(
            ...
            Container(
              ...
              padding: EdgeInsets.only(
                  top: 17.h, left: 15.w, right: 15.w, bottom: 15.h),
              decoration: BoxDecoration(
