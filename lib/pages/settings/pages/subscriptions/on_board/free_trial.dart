...
class FreeTrial extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var style16 = TextStyle(
        fontFamily: 'satoshi', fontSize: 16.sp, fontWeight: FontWeight.w600);
    var style12 = TextStyle(
        fontFamily: 'satoshi', fontSize: 12.sp, fontWeight: FontWeight.w400);
      ...
      body: Container(
        ...
        child: Column(
          children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                                margin:
                                    EdgeInsets.only(top: 60.h, bottom: 27.h),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: Text(
                            'Start your full access to all the sections of App.',
                            style: style12,
                          )),
                      Text(
                        'Day 5',
            ...
            Text(
              "Unlimited free access for 7 days, then US \$15.49 per year (US \$1.29 per month)",
              style: TextStyle(
                  fontFamily: 'satoshi',
                  fontSize: 14.sp,
            ...
            BrandButton(
                ...
                onTap: () async {
                  ...
                  Provider.of<ProfileProvider>(context, listen: false)
                      .setFromWhere("fromInApp");
                  if (loginStatus != 0) {
                    await showInAppBottonSheet(context);
                  } else {
                    var result = await Navigator.of(context)
                        .pushNamed(RouteHelper.signIn);
