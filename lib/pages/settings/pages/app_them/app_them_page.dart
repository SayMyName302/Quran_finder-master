...
class _AppThemPageState extends State<AppThemPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: buildAppBar(
          context: context, title: localeText(context, "app_theme")),
        ...
        child: Column(
          children: [
            Container(
              ...
              child: CircleAvatar(
                backgroundColor:
                    currentIndex == 0 ? Colors.amber : Colors.transparent,
            ...
            Text(
              localeText(context, 'choose_app_theme'),
              style: TextStyle(
                  fontFamily: 'satoshi',
                  fontSize: 18.sp,
            ...
            Text(
              localeText(context, 'customize_the_app_experience'),
              style: TextStyle(
                  fontFamily: 'satoshi',
                  fontSize: 14.sp,
                  fontWeight: FontWeight.w900,
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(
                              child: Text(
                            index == 0
                                ? localeText(context, "light_mode")
                                : localeText(context, 'dark_mode'),
                            style: TextStyle(
                                fontSize: 11.94.sp,
                                color: index == currentIndex
                                    ? Colors.white
