...
class Page1State extends State<Page1> {
  ...
  void _toggleSelection(int index, String filePath) {
    if (_startIndex != null && _endIndex != null) {
      ...
      _startIndex = null;
      _endIndex = null;
      // print('Start Index is>>$_startIndex');
      // print('End Index is>>$_endIndex');
      ...
      if (start > end) {
        ...
        print('Start Index after swap>>$start');
        print('End Index after swap>>$end');
      }
                    ...
                    Expanded(
                      child: Container(
                          ...
                          child: InkWell(
                              onTap: widget.isMultipleSelectionEnabled
                                  ? () {
                                      _toggleSelection(20, audioFilePaths[20]);
                                    }
                                  : () async {
                                      await _audioPlayer.stop();
                                      await _audioPlayer
                    ...
                    Expanded(
                      child: Container(
                          ...
                          child: InkWell(
                              onTap: widget.isMultipleSelectionEnabled
                                  ? () {
                                      _toggleSelection(25, audioFilePaths[25]);
                                    }
                                  : () async {
                                      await _audioPlayer.stop();
                                      await _audioPlayer
                                          .setAsset(audioFilePaths[25]);
                                      await _audioPlayer.play();
                                    },
                              child: Stack(children: [
                                FractionallySizedBox(
