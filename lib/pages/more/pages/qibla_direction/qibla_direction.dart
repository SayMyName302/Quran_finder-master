...
class _QiblaDirectionPageState extends State<QiblaDirectionPage> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar(context: context,title: localeText(context, "qibla_direction")),
                    ...
                    child: Row(
                      children: [
                        Container(
                            ...
                            child: Image.asset('assets/images/app_icons/send.png',height: 15.h,width: 15.h,color: appColors.mainBrandingColor,)),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(Dimensions.width < 330 ? qibla.address.substring(0,qibla.address.contains(",") ? qibla.address.indexOf(",") : 15): qibla.address,style: TextStyle(
                                color: them.isDark ? AppColors.grey6 : AppColors.grey2,
                                fontFamily: 'satoshi',
                                fontSize: 18.sp,
                            ...
                            SizedBox(height: 2.h,),
                            Text(localeText(context, 'your_current_location'),style: TextStyle(
                      ...
                      builder: (context, snapshot) {
                        if(snapshot.hasData){
                          ...
                          return Column(
                            children: [
                              Container(
                                ...
                                child: AnimatedBuilder(
                                  ...
                                  builder: (context, child) {
                                    return Transform.rotate(angle: animation!.value,child: Image.asset(
                              ...
                              Row(
                                ...
                                children: [
                                  Text(localeText(context, "degree_of_the_qibla"),style: TextStyle(
                                      fontSize: 16.sp,
                                      fontFamily: 'satoshi',
                                  ...
                                  Container(
                                    ...
                                    child: Text(degree.toString(),style: TextStyle(
                                        fontSize: 12.sp,
                                        color: Colors.white,
                                        fontFamily: 'satoshi',
                                        fontWeight: FontWeight.w700
                          ...
                          return Container(
                              ...
                              child: CircularProgressIndicator(color: them.isDark ? Colors.white : appColors.mainBrandingColor,));
                        }
                      }
                  ),
                  Container(
                    margin: EdgeInsets.only(top: 24.h,bottom: 24.h),
                    padding: EdgeInsets.only(left: 13.w,right: 13.w,top: 13.h,bottom: 12.h),
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8.r),
                        color: them.isDark ? AppColors.darkColor : Colors.white,
                        boxShadow: const [BoxShadow(offset: Offset(0,5),blurRadius: 15,color: Color.fromRGBO(0, 0, 0, 0.08))]
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            Text(localeText(context, 'distance_to_qibla'),style: textStyle,),
                            Text('${qibla.qiblaDistance} ${localeText(context, "km")}',style: textStyle,)
                          ],
                        ),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(localeText(context, 'longitude'),style: textStyle,),
                            Text(qibla.lng.toString(),style: textStyle,)
                          ],
                        ),
                        SizedBox(height: 10.h,),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(localeText(context, 'latitude'),style: textStyle,),
                            Text(qibla.lat.toString(),style: textStyle,)
                          ],
                        )
                      ],
                    ),
