          ...
          return ListView.builder(
            ...
            itemCount: value.salahStepList.length,
              itemBuilder: (context, index) {
                ...
                return Container(
                  padding: EdgeInsets.only(left: 13.w,right: 12.w,top: 11.h,bottom: 16.h),
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: Text(salahSteps.stepNumber!,style: TextStyle(
                          ...
                          Text(salahSteps.title!,style: TextStyle(
                              fontWeight: FontWeight.w700,
                              fontFamily: 'satoshi',
                              fontSize: 14.sp
                          ))
