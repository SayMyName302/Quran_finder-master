...
class TasbeehPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer4<LocalizationProvider, TasbeehProvider, ThemProvider,
        AppColorsProvider>(
      builder: (context, language, tasbeehValue, them, appColors, child) {
        return Scaffold(
          appBar: buildAppBar(
              context: context, title: localeText(context, "tasbeeh")),
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: List.generate(
                        tasbeehValue.tasbeehList.length,
                        (index) => Expanded(
                              child: InkWell(
                                onTap: () {
                                ...
                                child: Container(
                                  margin: EdgeInsets.only(
                                      right: language.locale.languageCode ==
                                                  "ur" ||
                                  ...
                                  decoration: BoxDecoration(
                                      color: tasbeehValue.currentTabeeh == index
                                  ...
                                  child: Column(
                                    children: [
                                      Text(
                                        tasbeehValue
                                            .tasbeehList[index].arabicName,
                                        // tasbeehValue.currentTabeeh == index ? Colors.white :
                                        style: TextStyle(
                                            color: them.isDark
                                                ? Colors.white
                                                : tasbeehValue.currentTabeeh ==
                                                        index
                                                    ? Colors.white
                                                    : Colors.black,
                                            fontFamily:
                                      ...
                                      Text(
                                          localeText(
                                              context,
                                              tasbeehValue.tasbeehList[index]
                                                  .englishName),
                                          style: TextStyle(
                                              color:
                                                  tasbeehValue.currentTabeeh ==
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    margin: EdgeInsets.only(
                        top: 8.h, bottom: 27.h, left: 20.w, right: 20.w),
                    padding: EdgeInsets.only(top: 12.h, bottom: 12.h),
                    decoration: BoxDecoration(
                        color: them.isDark
                            ? tasbeehValue.isCustomTasbeeh
                                ? appColors.mainBrandingColor
                                : AppColors.darkColor
                            : tasbeehValue.isCustomTasbeeh
                                ? appColors.mainBrandingColor
                    ...
                    child: Text(
                      localeText(context, "other_tasbeeh_of_your_choice"),
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          color: tasbeehValue.isCustomTasbeeh
                              ? Colors.white
                              : them.isDark
                                  ? Colors.white
                                  : Colors.black),
                      ...
                      Container(
                        margin: EdgeInsets.only(
                            left: language.locale.languageCode == "ur" ||
                                ...
                                ? 5.w
                                : 10.w,
                            right: language.locale.languageCode == "ur" ||
                                    language.locale.languageCode == "ar"
                                ? 20.w
                                : 5.w),
                            ...
                            return InkWell(
                              ...
                              child: Container(
                                ...
                                child: CircleAvatar(
                                  radius: 21.5.r,
                                  backgroundColor:
                                      tasbeehValue.selectedCounter == index
                                          ? appColors.mainBrandingColor
                                          : Colors.transparent,
                                  child: Text(
                                    tasbeehValue.counterList[index].toString(),
                                    style: TextStyle(
                                        fontWeight: FontWeight.w400,
                                        fontFamily: "satoshi",
                                        color: tasbeehValue.selectedCounter ==
                                                index
                                            ? Colors.white
                                            : them.isDark
                                                ? Colors.white
                      ...
                      InkWell(
                        onTap: () async {
                          await showCounterDialog(
                              context, tasbeehValue, appColors);
                        },
                        child: Container(
                          margin: EdgeInsets.only(
                              right: language.locale.languageCode == "ur" ||
                          ...
                          child: Text(
                            '|${localeText(context, "custom_count")}',
                            style: TextStyle(
  ...
  Future<void> showCounterDialog(BuildContext context,
      TasbeehProvider tasbeehValue, AppColorsProvider appColors) async {
    await showDialog(
      context: context,
      builder: (context) {
        ...
        return Consumer<TasbeehProvider>(
          builder: (context, value, child) {
            return AlertDialog(
              ...
              title: Text(localeText(context, "enter_tasbeeh_count"),
                  textAlign: TextAlign.center,
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        localeText(context, "enter_the_count"),
                    ...
                    BrandButton(
                        text: localeText(context, "confirm"),
                        onTap: () {
                          if (text.text.contains(".") ||
                            ...
                            tasbeehValue.setCustomCounter(
                                int.parse(text.text), context, appColors);
