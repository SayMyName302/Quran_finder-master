...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:
          Consumer3<MainPageProvider, AppColorsProvider, ThemProvider>(
          ...
          return Column(
            ...
            children: [
              ...
              BottomNavigationBar(
                items: [
                  BottomNavigationBarItem(
                      ...
                      icon: Container(
                          ...
                          child: const ImageIcon(
                            AssetImage(
                              'assets/images/app_icons/home.png',
                            ),
                          ))),
                  BottomNavigationBarItem(
                  ...
                  BottomNavigationBarItem(
                      ...
                      icon: Container(
                          margin: EdgeInsets.only(bottom: 5.h),
                          child: const ImageIcon(
                            AssetImage('assets/images/app_icons/more.png'),
                          ))),
                ],
                ...
                selectedLabelStyle:
                    TextStyle(fontFamily: 'satoshi', fontSize: 10.sp),
