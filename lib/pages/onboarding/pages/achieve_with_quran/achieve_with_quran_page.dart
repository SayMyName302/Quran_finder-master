...
class AchieveWithQuranPage extends StatelessWidget {
              ...
              children: [
                ...
                Consumer<OnBoardingProvider>(
                  builder: (context, achieve, child) {
                    return buildListOfAchieve(context, achieve, isDark, appColors);
                  },
                ),
  ...
  MediaQuery buildListOfAchieve(BuildContext context, OnBoardingProvider achieve, bool isDark, AppColorsProvider appColors) {
  ...
  Container buildGoalsText(Color appColor) {
    return Container(
      ...
      margin: EdgeInsets.only(bottom: 15.h,),
      child: Text(
          localeText(RouteHelper.currentContext,"choose_upto_3_goals_for_precise_personalization"),
          style: TextStyle(
  ...
  Container buildSubTitleContainer(bool isDark) {
    return Container(
      margin: EdgeInsets.only(bottom: 15.h,),
      child: Text("We will provide custom recommendations to fit your individual goals.",style: TextStyle(
          fontFamily: 'satoshi',
          fontSize: 14.sp,
          fontWeight: FontWeight.w500,
