...
class WhenToRecite extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                OnBoardingTitleText(title: localeText(context, "when_do_you_like_to_recite?")),
                Consumer<OnBoardingProvider>(
                  builder: (context, provider,child) {
                    return buildTimingList(context, provider, isDark, appColors);
                  },
                ),
                SizedBox(height: 6.h,),
  ...
  MediaQuery buildTimingList(BuildContext context, OnBoardingProvider provider, bool isDark, AppColorsProvider appColors) {
          ...
          return InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: whenToRecite == provider.selectTimeLikeToRecite ? isDark ? AppColors.brandingDark : AppColors.lightBrandingColor : Colors.transparent,
                  border: Border.all(color: whenToRecite == provider.selectTimeLikeToRecite ? appColors.mainBrandingColor : isDark ? AppColors.grey3 : AppColors.grey5),
                  borderRadius: BorderRadius.circular(6.r)
              ),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(localeText(context, whenToRecite),style: TextStyle(
                      fontFamily: 'satoshi',
                      fontSize: 12.sp,
                      fontWeight: FontWeight.w500
                  ),),
                  whenToRecite == provider.selectTimeLikeToRecite ? Stack(
                      children: [
