          ...
          builder: (context, language, child) {
            return Column(
              ...
              children: [
                ...
                time.inSeconds != 0 ? Container(
                  margin: EdgeInsets.only(left: 20.w, right: 20.w, bottom: 8.h),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text14(title: localeText(context,'your_engagement')),
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Text(
                                  time.inSeconds >= 61 && time.inMinutes <= 60?  '${time.inMinutes} ${localeText(context,'minutes')}'
                                ...
                                Container(
                                  ...
                                  child: Text('21% ${localeText(context,'from_last_week')}',
                                    style: TextStyle(
                                        fontFamily: 'satoshi',
                                        fontSize: 8.sp,
                                        color: AppColors.mainBrandingColor
                            ...
                            SizedBox(height: 1.h,),
                            Text(_formatDuration(time),style: TextStyle(
                              fontSize: 10.sp,
                              fontFamily: "satoshi",
                              fontWeight: FontWeight.w700,
                            ),),
                ...
                lastSeen != null ? Container(
                    ...
                    child: Text14(title: localeText(context,'continue_where_you_left_off'),)
                ) : const SizedBox.shrink(),
                ...
                HomeRowWidget(text: localeText(context,'islam_basics'), buttonText: localeText(context,"view_all"), onTap: () {
        ...
        builder: (context, islamBasicProvider, child) {
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                onTap: (){
                  islamBasicProvider.checkAudioExist(islamBasics.title!, context);
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: AssetImage(islamBasics.image!),fit: BoxFit.cover)
                  ),
                  child: Container(
                    ...
                    child: Text(localeText(context, islamBasics.title!),
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 13.8.sp,
                          fontFamily: "satoshi",
        ...
        builder: (context, storiesProvider, child) {
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                onTap: (){
                  Future.delayed(Duration.zero,()=>context.read<PlayerProvider>().pause());
...
showProgressLoading(double downloaded,BuildContext context,bool isFromStory) async {
  await showDialog(
      context: context,
      useSafeArea: false,
      builder: (context) {
