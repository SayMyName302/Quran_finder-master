...
import 'package:nour_al_quran/pages/home/sections/basics_of_quran/islam_basics_provider.dart';
...
class StoryPlayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: buildAppBar(context: context,font: 16.sp,title: localeText(context, "now_playing")),
        body: Consumer5<ThemProvider,StoryPlayerProvider,AppColorsProvider,QuranStoriesProvider,IslamBasicsProvider>(
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: Image.asset(player.image,).image,
                            fit: BoxFit.cover
                          )
                        ),
                        margin: EdgeInsets.only(left: 20.w,right: 20.w,bottom: 25.h),
                    ),
                    Text(localeText(context, fromWhere == "fromStory" ? story.selectedQuranStory!.storyTitle! : basics.selectedIslamBasics!.title!),style: TextStyle(
                      fontFamily: 'satoshi',
                      ...
                      Row(
                        ...
                        children: [
                          IconButton(
                            onPressed: (){
                              if(fromWhere == "fromStory"){
                                story.goToStoryDetailsPage(story.currentStoryIndex,context);
                              }else{
                                basics.goToIslamTopicPage(basics.currentIslamBasics, context);
                              }

                            },
                            icon: Image.asset('assets/images/app_icons/story.png',height: 18.h,width: 18.w,color: them.isDark ? Colors.white : Colors.black,),
                          ...
                          IconButton(onPressed: () async{
                            ...
                            children: [
                              Image.asset('assets/images/app_icons/speed.png',height: 15.h,width: 18.75.w,color: them.isDark ? Colors.white : Colors.black,),
                              SizedBox(width: 5.w,),
                              Text("${player.speed}x",style: TextStyle(fontWeight: FontWeight.w700,fontFamily: 'satoshi',fontSize: 12.sp),)
                            ],
                          ),
                            padding: EdgeInsets.zero,
                            alignment: Alignment.center,
