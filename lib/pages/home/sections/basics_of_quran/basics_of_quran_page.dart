          ...
          Expanded(
            child: Consumer<IslamBasicsProvider>(
              builder: (context, islamBasicProvider, child) {
                return islamBasicProvider.islamBasics.isNotEmpty ? GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      onTap: () async{
                        islamBasicProvider.checkAudioExist(model.title!, context);
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: Container(
                            ...
                            child: Text(localeText(context, model.title!),
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 12.sp,
                                  fontFamily: "satoshi",
