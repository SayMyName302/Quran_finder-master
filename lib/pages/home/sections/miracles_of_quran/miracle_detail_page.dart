...
class _MiraclesDetailsPageState extends State<MiraclesDetailsPage> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.file(context.read<MiraclesOfQuranProvider>().videoUrl!)..initialize().then((value) {
      setState(() {});
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          _controller.value.isInitialized ? InkWell(
            onTap: (){
              setState(() {
            ...
            child: Stack(
              ...
              children: [
                ...
                Positioned(
                    left: 0,
                    right: 0,
                    child: !_controller.value.isPlaying ? CircleButton(
                      height: 50.h,
                      width: 50.h,
