...
class QuranPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var pageNames = [localeText(context, "recitation"),localeText(context, "surah"),localeText(context, "juz"),localeText(context, "resume"),localeText(context, "bookmarks"),localeText(context, "duas"),localeText(context, "favorites")];
    var pages = [
          ...
          return Column(
            ...
            children: [
              Container(
                  ...
                  child: TitleText(title: localeText(context, "quran"),)),
              Container(
                height: 23.h,
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: index == value.currentPage ? appColors.mainBrandingColor : AppColors.grey6,
                            borderRadius: BorderRadius.circular(12.r)
                        ),
                        child: Center(child: Text(pageNames[index],style: TextStyle(
                          color: index == value.currentPage ? Colors.white : AppColors.grey3,
