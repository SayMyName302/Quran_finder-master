...
class AudioPlayerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer3<ThemProvider,PlayerProvider,AppColorsProvider>(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    player.surah != null ? Column(
                      children: [
                        Text("Surah ${player.surah!.surahName}",style: TextStyle(fontSize: 22.sp,fontFamily: 'satoshi'),),
                        SizedBox(height: 7.h,),
                        Text('${localeText(context, "surah")} # ${player.surah!.surahId}',style: TextStyle(fontSize: 14.sp,fontFamily: 'satoshi',color: them.isDark ? AppColors.grey4: AppColors.grey3),),
                      ],
                        ...
                        IconButton(
                          onPressed: (){
                            if(!isLoopMore){
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Loop More On For ${player.surah!.surahName!}')));
                            }else{
                              isLoopMore = false;
                              player.audioPlayer.setLoopMode(LoopMode.off);
                              ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Loop More Off For ${player.surah!.surahName!}')));
                            }
                          },
                          icon: Image.asset('assets/images/app_icons/repeat.png',height: 18.h,width: 18.w,color: them.isDark ? Colors.white : Colors.black,),
      ...
      useSafeArea: true,
        ...
        context: context, builder: (context) {
          return Scaffold(
            ...
            body: Consumer2<PlayerProvider,AppColorsProvider>(
