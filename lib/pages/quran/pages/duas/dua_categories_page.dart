      ...
      children: [
        ...
        Consumer<DuaProvider>(
          builder: (context, duaValue, child) {
            return duaValue.duaCategoryList.isNotEmpty ? Expanded(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: ()async{
                      ...
                      Navigator.of(context).pushNamed(RouteHelper.dua,arguments: [localeText(context, duaCategory.categoryName!),LocalizationProvider().checkIsArOrUr() ? "${duaCategory.noOfDua!} ${localeText(context, 'duas')} ${localeText(context, 'collection_of')} ":"${localeText(context, 'collection_of')} ${duaCategory.noOfDua!} ${localeText(context, 'duas')}"]);
                    },
                    child: Container(
                      height: 175.h,
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(image: AssetImage(duaCategory.imageUrl!),fit: BoxFit.cover)
                      ),
                      child: Container(
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(8.r),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(localeText(context, duaCategory.categoryName!),style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 14.sp,
                                  fontFamily: "satoshi",
                                  fontWeight: FontWeight.w700),),
                              Text(LocalizationProvider().checkIsArOrUr() ? "${duaCategory.noOfDua!} ${localeText(context, 'duas')} ${localeText(context, 'collection_of')} ":"${localeText(context, 'collection_of')} ${duaCategory.noOfDua!} ${localeText(context, 'duas')}",style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 10.sp,
                                  fontFamily: "satoshi",
            ...
            ) : Expanded(child: Center(child: CircularProgressIndicator(color: appColors,),));
          },
        )
      ],
    );
