                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: ()async{
                      ...
                      Navigator.of(context).pushNamed(RouteHelper.dua,arguments: [duaCategory.categoryName,duaCategory.noOfDua]);
                    },
                    child: Container(
                      height: 175.h,
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(duaCategory.categoryName!,style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 14.sp,
                                  fontFamily: "satoshi",
                                  fontWeight: FontWeight.w700),),
                              Text(duaCategory.noOfDua!,style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 10.sp,
                                  fontFamily: "satoshi",
