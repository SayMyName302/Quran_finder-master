...
import '../pages/bookmarks/bookmarks_provider.dart';
import '../providers/quran_provider.dart';
import '../../settings/pages/fonts/font_provider.dart';
import '../../settings/pages/translation_manager/translation_manager_provider.dart';
...
import '../pages/resume/last_seen_provider.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Consumer2<AppColorsProvider, QuranProvider>(
        builder: (context, appColor, quranProvider, child) {
          return quranProvider.isJuz == false && quranProvider.nextSurah != null
              ? Container(
