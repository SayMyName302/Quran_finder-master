            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(localeText(context, "create_an_account_to_save_your_progress"),style: TextStyle(
                      fontFamily: "satoshi",
                      fontSize: 22.sp,
                ...
                Container(
                  ...
                  child: Text(localeText(context, "let's_get_started_on_the_quran_pro_app"),style: TextStyle(
                      fontFamily: 'satoshi',
                      fontSize: 16.sp,
                ...
                SizedBox(height: 10.h,),
                BrandButton(
                    text: localeText(context, "register"), onTap: (){
                  Navigator.of(context).pushNamed(RouteHelper.yourName,arguments: [email.text,password.text]);
                }),
                Container(
                    margin: EdgeInsets.only(top: 16.h),
                    width: double.maxFinite,
                    child: Text(localeText(context, 'or_register_using'),textAlign: TextAlign.center,style: TextStyle(
                      fontFamily: 'satoshi',
                      fontSize: 10.sp,
                      fontWeight: FontWeight.w500
                    ),)),
                ...
                buildRegisterOrHaveAccountContainer(title: localeText(context, "already_have_account_an_account_login"), onPress: (){
